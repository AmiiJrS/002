...
kt = LINETCR.LINE()
kt.login(token="EnVAKi465IsrNb5WP1T1.JfCtHOqQfDhIFCfpOIzoeq.gGXino/PQk7O6lsP9BJi6L5sB3QHyithHedHiK/Rq54=")
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token="En76eiS877UDyJYaYTLb.Cu584iN8cI2QN/belsU9sW.fTKNvsAzhWWz5kHG4EJwWIawvUBktTIof77MqxpTuZI=")
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token="EnUnQkiIuDPBKpcZVjj6.qSMKZTpn3HbTnntbQ8035G.KCtO0IBrD5ZXhoweHz1CC4xAQXEVOwSuv9EeXgsgcsQ=")
ki.loginResult()
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,"u78e5efff85bf97393cc2c4b8ecf93d25"]
admin = ["u78e5efff85bf97393cc2c4b8ecf93d25"]
owner = ["u78e5efff85bf97393cc2c4b8ecf93d25"]
wait = {
    'contact':False,
    'autoJoin':True,
        ...
        if op.type == 26:
            ...
            if "@"+cl.getProfile().displayName in msg.text:
                    if wait["tag"] == True:
                        ...
                        jawab = (cl.getProfile().displayName +" sedang sibuk \nAda Perlu Chat aja 👇👇👇")
                        jawaban = (jawab)
                        cl.sendText(msg.to,jawaban)
                        msg.contentType = 13
                        msg.contentMetadata = {'mid': mid} 
