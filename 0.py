...
cl = LINETCR.LINE()
cl.login(token="EoUNIq6jyAiWhS9ppgC1.vAh6wndTY3Wr8qqkNOWVuq.dX0W9M9+z4/SaFAYKys6yihsRhExAFGHu00U3bt3kAI=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EoM5yUaBetTEtq8kIHT9.lWMwFVD7NJiQfssCsllWIq.q5WnCtDm7GWBxDteixz5JQSoA2fUf0a5I3Vy1BHyhfo=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Eo5vfT6dtOnERcZrqLS1.YlXOM+3GDg8xgwiHbb0/Kq.DOQVoNApTO8XE4VGm4pZ07Y+6eXeR8ncX/yJUV/SAXI=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EoCMR9Fygax4c2pPSTq5.4CCG8UKkDgoXxH7XQhzdrq.2W8LD8Ab+Mns+h4paCHCY+4npWxDCkL4sqhm7R1A9qA=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EovP7AMf2qzku16t4og4.tXznW3f4379u6k5O0HFmba.FsR2xD0CZ6Ma0rMVIUacfVgtS2CHp64nzmKD8hGWzHg=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EonCyQIxtOUvSfJawxi4.MotZ4xkzoD13jVdFKkGOza.Ua4CKs5Za2d2bJGb2QdNRdYS1oxF9bxDeeVtYxuADO0=")
ki5.loginResult()

print ("login success zetsu")
reload(sys)
...
admsa = ["u55a1fa58d0edcb7c11f1040a9e8c2f51",mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid]
admin = ["u55a1fa58d0edcb7c11f1040a9e8c2f51",mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid]
Staff = []
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u55a1fa58d0edcb7c11f1040a9e8c2f51":
                    if "join:" in msg.text:
...
#--------------------------------------------------------
                ...
                start = time.time()
                cl.sendText(msg.to, "Wait Time Answer")
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%f <- speed/secconds" % (elapsed_time))
...
#-----------------------------------------------------------
                ...
                if msg.toType == 2:
                  ...
                  if msg.toType == 2:
                    ...
                    ki.sendText(msg.to,"(explosion) Just some casual cleansing (explosion)")
                    ki2.sendText(msg.to,"(explosion) Just some casual cleansing (explosion)")
                    ki3.sendText(msg.to,"(explosion) Just some casual cleansing (explosion)")
                    targets = []
                    for g in gs.members:
                        if _name in g.displayName:
                            targets.append(g.mid)
