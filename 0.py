...
cl = LINETCR.LINE()
cl.login(token="EolPkqwCdlq3e1HW3v07.qIxj4vzAKChsjMi6Mq4SHW.+8Pp5O6wabZtGwYS5dKwyb+kMnROpimW+8jH0QNsCho=")
#cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Eo9JHTjETbXq4XtlDKNa.uQBAV6niuqIYEx6IRjlqUG.J7T9MQpMoDcCvmUzxYiInd7dIQDVkn8VQ8VRDDFN7nA=")
#ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EoafmlQ5e1Vpq7mtmSP7.z+tLfStEu3iHJZoEJ9LP1W.keK9+Nw0ETOX0hajBI4MoVh6nHtRbegFFVMVOauZXDg=")
#ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EoxQMGRlEonkDcvmygI1./gCGY+UAYTYTfYmZIOjt4q.ksmIc2Y2bkuTMWadkDU9W7XNrPHa1iB+GPz8iSGVlGk=")
#ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="Eo4PpkuYLd6k8BXIPGYd.8agIL6JpkiXwkcblK/63dq.H/VzNvbZV47y8oMFPgDognyMy+6I4Sogy4aHsVd1PkA=")
#ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EoU6VKDP32H2UWz7MFG5.SOy7vJxIlw5YCrWWW6Yenq.q9PUVSc6iDEwOKInolse4TmbEpUAvJJNc+PeGaWmLRI=")
#ki5.loginResult()
...
helpMessage ="""Self Bot By 🛡️ᴀᴍɪɪ🛡️
 ~~~~~~~ Command ~~~~~~~
...
¤  Ban @      - Via Tag
¤  Unban @    - Via Mid
¤  Ban        - Via Send Contact
¤  Unban      - Via Send Contact
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,"u4225c9e1565a91c1d226623a990e2c87"]
admsa = "u4225c9e1565a91c1d226623a990e2c87"
admin = "u4225c9e1565a91c1d226623a990e2c87"
...
#======================================================
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u78e5efff85bf97393cc2c4b8ecf93d25":
                    if "join:" in msg.text:
                         ...
                         if targets == []:
                             ...
                             for target in targets:
                                 try:
                                     ...
                                     random.choice(KAC).sendText(msg.to,"Invited this : \n➡" + _name)
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "---------------\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n---------------\nIn the last seen point:\n[%s]\n---------------\n [☸]➦Powered By: 🛡️ᴀᴍɪɪ🛡️" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
              ...
              if msg.from_ in admin:
                ...
                for target in targets:
                   try:
                      ...
                      cl.sendText(msg.to,"WL Di Tambahkan!")
                   except:
                      pass
            
            elif ("Wl off " in msg.text):
              if msg.from_ in admin:
                key = eval(msg.contentMetadata["MENTION"])
                key["MENTIONEES"][0]["M"]
                targets = []
                ...
                for target in targets:
                   try:
                      ...
                      f=codecs.open('st2__b.json','w','utf-8')
                      json.dump(wait["whitelist"], f,sort_keys=True, indent=4,ensure_ascii=False)
                      cl.sendText(msg.to,"Sukses Hapus WL!")
                   except:
                      pass
             ...
             if msg.from_ in admin:           
              ...
              if msg.from_ in admin:
                if wait["blacklist"] == {}:
                    ...
                    cl.sendText(msg.to,"Daftar Whitelist􏿿")
                    mc = "[⎈]Whitelist [⎈]\n"
