...
cl = LINETCR.LINE()
cl.login(token="EoovhErd5X2Pc4MtFz55.EoxV+4w+LZK8WSs47pK9jq.xCnBKh+Dv1J2gvyHEEIvkpMRwKFvMnOd0MHoXNirtTs=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EoobXFUOEgvVuRS1S7wa.Talcs3tb8aLVd6Vv5xk92G.yOiTAPRJNH6KyxJIGD3Ze0Yv7wbdVuNd3hZr/o+C5KU=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Eo3F69bVFnGlIgTs4jT3.Af2Tn/2TNeIF5TI42tFyqW.c1dgh4Zh1xp9xe3+qG2jnxLLtDPtL6+pDoCaSW9bl5Y=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EoixMrAvJvmRc799pJU9.hQAEnSMhKVwa4RpxrJHtIq.NVTwwuIvMM+s22rbexYtnyw8gmcS0qnkOzLJGzoxH00=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EoaISvUWd4zPH3SsHHQ1.JfCtHOqQfDhIFCfpOIzoeq.JIjS2nQRbHTSARDDtOEiO+8FxxJ/hGxLrfpdPTQQZo0")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EotVuOxRv7N9KqclVJl5.zaE6e6IBtOrrPYccrmUXrq.bQyORS/h9gHkHotKhkqzWCd97wU2LtHdMuLK54KpZzc=")
ki5.loginResult()
...
🛡️ youtube:
🛡️ Steal @ tag target
🛡️ Steal cover @ tag target
🛡️ Respon
🛡️ Lurking
🛡️ Lurk
🛡️ kill
🛡️ cancel
🛡️ Spam album: tag target
🛡️ Mentionall
🛡️ Mimic on/off
🛡️ Target list
🛡️ Mimic target
...
🛡️ Qr on/off
🛡️ Denyinvites on/off
🛡️ Protect on/off
🛡️ Cancel on/off

💠️Creator By: 💠️──ᴀᴍɪɪ──💠️
"""
...
admsa = ["u78e5efff85bf97393cc2c4b8ecf93d25",mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid]
admin = ["u78e5efff85bf97393cc2c4b8ecf93d25",mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid]
Staff = []
wait = {
    'contact':False,
    'autoJoin':True,
