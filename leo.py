...
cl = LINETCR.LINE()
cl.login(token="Enqz4hHrsdkiITTdgkua.TP5YsNK3+FrPp+s9pNddwG.ThUBDw3SlfTig9sbM6UUGnrw5GcHp5xaInCEMyZJfgo=")
cl.loginResult()

kt = LINETCR.LINE()
kt.login(token="En0AUX2MOrIE2SQ3KPb7.VGvfRaJnqbX6QpqO8kj6zW.W8USuJls2DEWYkRblJJwhN9YcdSeQBUtZERWLIee660=")
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token="EnxkfXc8Td6UyFrAv6jc.X8NJJ2GpI5n6zte65lbjha.NsQR7mQtw8HPeicYuu8vMVXWDNg8OBy1Z6rOG3RzwwI=")
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token="EnM9zzZ8dtrpVI40o8e7.wpYVBAlNnBHYGDo0eFjMnW.I4u/ogHNe27EzfdG0npDeZFS0+NoYEiZ/5gu9GFQen8=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EnWjoqa3bOPEdRh6orr5.DuG7fFDXzIjOjFTseF3ITq.OwFUrl29BwPIiAhbv1zQSLL0nK/X6wB4XF19TBV+Kow=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EnDNm7JcK7S03xSXHVte.Z+JfmoGx0rpgu0BTVzGDJG.K3ctMuarEWWGtw2SUIoHNC/MPa98FRKNhAT6hKuVUjk=")
kc.loginResult()
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,"ub69e724a7937fdf4693ff4bd3e70c35a"]
admin = ["ub69e724a7937fdf4693ff4bd3e70c35a"]
owner = ["ub69e724a7937fdf4693ff4bd3e70c35a"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#===========================================
              ...
              if msg.from_ in admin:
                profile = cl.getProfile()
                text = profile.displayName + "􀜁􀅔 Cʳᵒᵗ"
        ...
        if op.type == 26:
            ...
            if "@"+cl.getProfile().displayName in msg.text:
                    if wait["tag"] == True:
                        ...
                        jawab = (cl.getProfile().displayName +" Gak Perlu Jangan Tag!!! \nKalo Perlu Chat Aja 👇👇👇")
                        jawaban = (jawab)
                        cl.sendText(msg.to,jawaban)
                        msg.contentType = 13
                        msg.contentMetadata = {'mid': mid} 
