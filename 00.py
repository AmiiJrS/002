...
#ADMIN 
cl = LINETCR.LINE()
cl.login(token="EozoHUD24bBdvNrJiELe.hJ6OS27ZxlCSZFmMi++wlG.ttjtte8sxBBYx+w5D7eiy8pXCC6kPSZ3NIOx9JlrfjU=")

#DTB1
kt = LINETCR.LINE()
kt.login(token="EolQRXbnHWpyclPu2xT9.BnT5+wuIUZDBwsJtpBtkYq.90M5iupe1B5JvQSqYVT+h2tIQFP7/t9t1E6SjrlnGYY=")

#DTB2
ks = LINETCR.LINE()
ks.login(token="EoAWVGFnwTEDiOmX8CHf.w8WjQ5YYUi8MX/mowRpFZW.XDWAD63EJW4/0mkObZgvCybyFjCA7DSUIETf6KEK+mY=")

#DTB3
ki = LINETCR.LINE()
ki.login(token="EoEJ9xmvAqvuV1KaI3c1.ym/heHbxRZmza3vuhZzp8q.F3q10ChBoevTSqVfioyPDXkisfxiWYlRXVbX1GLvQkY=")

#DTB4
kk = LINETCR.LINE()
kk.login(token="Eo8TMNMjF9QQSXLSlDke.6v6loJKDOdhcGmohufs+3G.MyKjfbzB8YzlXJEjCj25Q4daIyfjPwo9D7d3mBVbArM=")

#iridessa
kc = LINETCR.LINE()
kc.login(token="EoWQutCLIQnnYHf43be4.NY1SLGUcS9sBsyVPCsExja.2xlkdU68ueZivWRvqodZ5JmEPyah7D9FeUgmatuhQdQ=")

#DTB6 kicker ghost
kl = LINETCR.LINE()
kl.login(token="Eovxl66ZPvjJzcg2UR77.pz/yHO8eziJsV+m4m9sR9W.TQHBhCxINqRo9sfBrjv6zl5cEg2yx48NEbBngsNY0zM=")
...
admin = ["u1e3ea8b36ef35cb72ccdf32623ffd62e"]
owner = ["u1e3ea8b36ef35cb72ccdf32623ffd62e"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------=============================   
	      ...
	      if msg.from_ in admin:
                ...
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'u1e3ea8b36ef35cb72ccdf32623ffd62e',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '5'}
                msg.text = None
                cl.sendMessage(msg)
              ...
              if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'u1e3ea8b36ef35cb72ccdf32623ffd62e', 'PRDTYPE': 'THEME', 'MSGTPL': '2'}
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text.lower() == 'gift3':
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'u1e3ea8b36ef35cb72ccdf32623ffd62e', 'PRDTYPE': 'THEME', 'MSGTPL': '3'}
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text.lower() == 'gift4':
              if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'u1e3ea8b36ef35cb72ccdf32623ffd62e', 'PRDTYPE': 'THEME', 'MSGTPL': '4'}
                msg.text = None
                kc.sendMessage(msg)
            elif msg.text.lower() == 'gift5':
              if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'u1e3ea8b36ef35cb72ccdf32623ffd62e', 'PRDTYPE': 'THEME', 'MSGTPL': '5'}
                msg.text = None
                kd.sendMessage(msg)
            elif msg.text.lower() == 'gift6':
              if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'u1e3ea8b36ef35cb72ccdf32623ffd62e', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}
                msg.text = None
                ke.sendMessage(msg)
...
#==================================================================
              ...
              if msg.from_ in admin:
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u1e3ea8b36ef35cb72ccdf32623ffd62e'}
                cl.sendMessage(msg)
...
#=================================================================
 ...
 #================================================================           
            ...
            elif msg.text in ["Dtb1 Invite"]:
              if msg.from_ in admin:
                 wait["winvite"] = True
                 kt.sendText(msg.to,"send contact")

            elif msg.text in ["Dtb2 Invite"]:
              if msg.from_ in admin:
                 wait["winvite"] = True
                 ki.sendText(msg.to,"send contact")

            elif msg.text in ["Dtb3 Invite"]:
              if msg.from_ in admin:
                 wait["winvite"] = True
                 kc.sendText(msg.to,"send contact")

            elif msg.text in ["Dtb4 Invite"]:
              if msg.from_ in admin:
                 wait["winvite"] = True
...
#-------------------------------------------------------
            ...
            elif msg.text in ["HELLO","Hello","helo"]:
              if msg.from_ in admin:
                ki.sendText(msg.to,"Hello juga bosku yang Ganteng 􀨁􀄻😎😎")
                kk.sendText(msg.to,"Hello juga bosku yang Ganteng 􀨁􀄻😎😎")
                kc.sendText(msg.to,"Hello juga bosku yang Ganteng 􀨁􀄻😎😎")
		ks.sendText(msg.to,"Hello juga bosku yang Ganteng 􀨁􀄻😎😎")
		kt.sendText(msg.to,"Hello juga bosku yang Ganteng 􀨁􀄻😎😎")
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to,"Success recover")
              ...
              if msg.from_ in admin:
                ...
                ks.sendText(msg.to, "Tᵘʰ ᵏᵃᵃⁿ Cʳᵒᵗ ˢʸᵍ.. 😃")                                    
#========================================
            elif msg.text in ["Dtb1 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["Dtb2 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["Dtb3 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["Dtb4 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["Dtb5 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["Dtb6 backup run"]:
                if msg.from_ in admin:
...
#-------------------------------------------------#
            elif msg.text in ["Token listrik","Toket","Listrik","Begal",]:
              if msg.from_ in admin:
                group = cl.getGroup(msg.to)
...
#-------------Fungsi Tag All Finish---------------#
            ...
            elif msg.text.lower() in ["Token listrik","Begal","Toket"]:
              if msg.from_ in admin:
                group = cl.getGroup(msg.to)
                nama = [contact.mid for contact in group.members]
