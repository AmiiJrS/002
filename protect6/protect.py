...
#vidia
kt = LINETCR.LINE()
kt.login(token="En8MhEi2Ijn0tUtL7GW6.l/9kZNGe0yHGuQH8o5NnrG.YbNOHMjrPtcZXVvUle2AXvzMkpGJm04VZ620ZpMvdNg=")

#rosetta
ks = LINETCR.LINE()
ks.login(token="EnXRCD7GOfR8fxNBbGZe.mQFs0cNoilcDiOT0MnwhFG.2ug/yl4leGoU0FrNC3AVKydj1R5mjT1C3PDY9cTkUPI=")

#sirvelmist
ki = LINETCR.LINE()
ki.login(token="EnN469ZMKQNfifKinzj2.ItPA0jqNEBqn+vY/3xxH4G.KGxcKEmR67hK5B9cLlzIX2pFaQ5vK/tajbwmHEOsnd0=")

#fawn
kk = LINETCR.LINE()
kk.login(token="EnyFYEkiciwF2y6EkiNf.RSHeMKjp1cCX+o66qp+LNW.O+Ant2NssmsUzB6FLYf8g88OQZoUrOXa9pweA458PPw=")
...
admin = ["u9c9d0b34d4db3d20112da09060d69b5f","u05a8b23ce790b58cad8b2a5668def8ce"]
owner = ["u9c9d0b34d4db3d20112da09060d69b5f","u05a8b23ce790b58cad8b2a5668def8ce"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------=============================   
	      ...
	      if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'u36196ea7137f95585062f8303dbac814', 'PRDTYPE': 'THEME', 'MSGTPL': '1'}
                msg.text = None
                cl.sendMessage(msg)
